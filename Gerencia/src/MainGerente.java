...
/*      ArrayList<String> parametros = new ArrayList<>();
        ...
        parametros.add("2021/08/07");
        parametros.add("2021/09/07");
        parametros.add("3000000");
        parametros.add("2");
        parametros.add("andres felipe");
        parametros.add("rocha sanchez");
        parametros.add("987654321");
        parametros.add("321564789");
        parametros.add("cr 25 n78");
        parametros.add("2");
//        conexion.consultaInsert("empleados",nombresParametros,parametros);
        nombresParametros1.add("fecha_retiro");
